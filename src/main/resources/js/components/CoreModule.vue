<template>
  <div>
    <h5 class="centerText" v-if="simulationEnabled">
      Simulation ON
      <span class="enableSimulTimer" v-if="simulationEnabled">{{
        $store.state.user.home.date
      }}</span>
    </h5>
    <h5 class="centerText" v-if="!simulationEnabled">
      Simulation OFF
      <span class="disableSimulTimer" v-if="!simulationEnabled">{{
        $store.state.user.home.date
      }}</span>
    </h5>
