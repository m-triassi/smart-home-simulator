            ...
            <tr>
                ...
                <td>
                    <div v-for="zone in this.$store.state.zones" :key="zone.id" class="zone_box">
                      ...
                      <table>
                          <tr>
                            <td v-for="(open, index) in zone.openings.map(opening => { return displayOpening(opening) })" :key="index"><span :key="index" v-html="open"></span></td> 
                          </tr>
                      </table>
                      <span>Lights in this zone:</span>
                      <div v-for="(open, index) in zone.appliances.map(appliance => { return displayLights(appliance) })" :key="index"><span :key="index" v-html="open"></span></div> 
                      <p></p>
                    </div>
                    <p>House Layout</p>
                </td>
    ...
    methods: {
        ...
        displayOpening(opening){
            ...
            if(opening.type == "window"){
                if(opening.state == 0){
                    result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/3190/3190083.svg\">"
                }
                else{
                    result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/3190/3190150.svg \">"
                }
            }
            else{
                if(opening.state == 0){
                    result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/32/32533.svg\">"
                }
                else{
                    result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/59/59801.svg \">"
        ...
        displayLights(appliance){
            ...
            if(appliance.state == 0){
                result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/82/82648.svg \">"
            }
            else{
                result = "<img class=\"icon\" src=\"https://www.flaticon.com/svg/static/icons/svg/3721/3721106.svg \">"
            }
            return result;
        }
    },
